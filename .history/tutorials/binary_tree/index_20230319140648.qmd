...
module btree
    ...
    Base.@kwdef mutable struct Internode <: VPL.Node
        length::Float64 = 0.2 # Internodes start at 10 cm
    end
    # Leaf
    Base.@kwdef struct Leaf <: VPL.Node
        length::Float64 = 0.05 # Leaves start at 5 cm
        width::Float64  = 0.05 # Leaves start at 5 cm
    end    

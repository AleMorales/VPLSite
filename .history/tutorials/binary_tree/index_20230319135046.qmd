...
*Leaf*: These are the nodes associated to leaves in the tree. They are represented by ellipses with a particular orientation and insertion angle. The insertion angle is assumed constant, but the orientation angle varies according to an elliptical phyllotaxis rule (120 degrees between leaves).
...
function VPL.feed!(turtle::Turtle, i::btree.Leaf, vars)
    ra!(turtle, angle = vars.phyllotaxis)

...
:::{.callout-important}
The Virtual Plant Laboratory is in development and it is released for the purposes
of testing and user feedback.
:::
...
VPL requires using Julia version 1.8 or higher. The installation of VPL is as
...
* *Ecophys.jl* - Algorithms and data structures to simulate ecophysiological processes including photosynthesis, transpiration, leaf energy balance, phenology or respiration.

* *Sky.jl* - Algorithms to simulate different sky conditions in terms of the intensity of solar radiation and its spatial distribution.

In addition, all the tutorials on this website can be found at the [VPLTutorials](https://github.com/AleMorales/VPLTutorials) package.

Some of the components currently in VPL will be moved to their own packages as 
part of the VPLverse in the future.
